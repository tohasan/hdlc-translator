...
class ApduFrameSpec extends Specification {
    ...
    def "should parse simple universal single item READ_RESPONSE apdu package"() {
        ...
        result ==
                ...
                '01 - нколичество элементов в блоке данных (Quantity) - 1\n' +  // количество элементов в блоке данных
                '00 - значение диагностики источника результата (0x00 - success)\n' +
                '12 - тип данных элемента данных в последовательности (ItemType) - DataType[12]\n' + // тип данных элемента в структуре - unsigned 16
                '0008 - длина элемента данных в байтах (ItemLength) - 8' // значение элементов в структуре - идентификатор класса
    }
    ...
    def "should parse multi items READ_RESPONSE apdu package"() {
        given:
        ...
        result ==
                ...
                '0000010000FF - значение элемента данных в структуре (ItemValue)\n' +
                '0F - тип данных элемента данных в последовательности (ItemType) - DataType[15]\n' + // тип данных элемента в структуре - integer 8
                '02 - индекс атрибута (AttributeIndex) - 2' // Attribute index=2
    }
