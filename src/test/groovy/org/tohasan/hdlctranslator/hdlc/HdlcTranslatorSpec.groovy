...
class HdlcTranslatorSpec extends Specification {
    ...
    def "should parse simple AARQ - lowest security level"() {
        given:
        def result = hdlcTranslator.parse('7E A0 2E 00 02 4A 19 21 10 B3 F4 E6 E6 00 60 1D A1 09 06 07 60 85 74 05 08 01 02 BE 10 04 0E 01 00 00 00 06 5F 1F 04 00 1C 03 20 00 00 38 5B 7E')
        ...
        result ==
                ...
                'A1 - длина запроса ассоциации приложения в байтах (ACSE Tag) - [161]\n' +
                ...
                'BE - длина запроса ассоциации приложения в байтах (ACSE Tag) - [190]\n' +
    ...
    def "should parse simple AARQ - low level authentication with blank password"() {
        given:
        def result = hdlcTranslator.parse('7E A0 4B 00 02 A0 AD 03 10 11 31 E6 E6 00 60 3A A1 09 06 07 60 85 74 05 08 01 02 A6 0A 04 08 45 47 4D 36 39 33 32 36 8A 02 07 80 8B 07 60 85 74 05 08 02 01 AC 02 80 00 BE 10 04 0E 01 00 00 00 06 5F 1F 04 00 1C 1B 20 00 00 B5 3C 7E')
        ...
        result ==
                ...
                '07 - длина значения элемента службы управления ассоциацией в байтах (ACSE Data Length) - 7\n' +
                '60857405080102 - значения элемента службы управления ассоциацией (ACSE Value)\n' +
                'A6 - длина запроса ассоциации приложения в байтах (ACSE Tag) - [166]\n' +
                ...
                '8A - длина запроса ассоциации приложения в байтах (ACSE Tag) - [138]\n' +
                ...
                '8B - длина запроса ассоциации приложения в байтах (ACSE Tag) - [139]\n' +
                ...
                'AC - длина запроса ассоциации приложения в байтах (ACSE Tag) - [172]\n' +
                '02 - длина элемента службы управления ассоциацией в байтах (ACSE Length) - 2\n' +
